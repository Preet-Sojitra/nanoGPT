# FINAL VERSION OF THE nanoGPT MODEL
# Scaled up version of the bigram model with multi-head self-attention and feedforward layers
...
# hyperparameters
batch_size = 64  # how many independet sequences we will process in parallel
block_size = 256  # what is the maximum context length of the predictions?
max_iters = 5000
eval_interval = 500
learning_rate = 3e-4
